...
<div className='text-2xl text-start w-full font-bold text-zinc-950 flex items-center gap-x-2 justify-start'> 
<span>&#8377;{isShow?amount: ``.padStart(amount.length,'x')}/-</span>
<button
  onClick={(e)=>{
                e.preventDefault()
                e.stopPropagation() 
 ...
 type='button' className='outline-none cursor-pointer text-blue-700'> 
 { !isShow? <FaEye/>:<FaEyeSlash/>} </button> 
          </div>  
